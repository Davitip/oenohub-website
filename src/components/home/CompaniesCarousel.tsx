...
import { CATEGORY_COLORS, CATEGORY_LABELS, COMPANIES } from '@/lib/companies'
        ...
        <div className="mb-12 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          ...
          >
            <p className="mb-3 flex items-center gap-3 text-xs font-semibold tracking-[0.06em] text-gold-500">
              ...
              ჩვენი ეკოსისტემის კომპანიები
            </p>
            <h2 className="font-serif text-3xl font-semibold text-ink-900 lg:text-[44px] lg:leading-[1.15]">
              10 კომპანია — <span className="font-display italic text-burgundy-700">ერთი სტანდარტი</span>
            </h2>
            <p className="mt-4 max-w-[62ch] leading-[1.7] text-ink-600">
              თითოეული კომპანია ეკოსისტემის ჯაჭვის საკუთარ რგოლს ფარავს — ერთად კი სრულ
              სერვისს ქმნიან ღვინისა და აგრო ბიზნესისთვის.
            </p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0 }}
          ...
          {COMPANIES.map((c) => (
            ...
            >
              ...
              <div className="flex h-full flex-col gap-4 p-7">
                ...
                <p className="text-sm leading-[1.7] text-ink-600">{c.description}</p>
                <a
                  href={c.url}
                  target="_blank"
                  rel="noreferrer"
