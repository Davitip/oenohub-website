    ...
    >
      ...
      <div className="relative mx-auto grid min-h-[70vh] max-w-[1280px] grid-cols-1 items-center gap-14 px-6 pb-20 pt-32 lg:grid-cols-[55%_45%] lg:gap-10 lg:px-12 lg:pb-24 lg:pt-40">
        ...
        <div className="relative mx-auto w-full max-w-[520px] lg:max-w-none">
          <motion.div
            style={{ y: yTop }}
            className="relative z-10 w-[78%] overflow-hidden rounded-[20px] border border-gold-500/25 shadow-2xl"
          >
            <motion.div
          ...
          <motion.div
            style={{ y: yBottom }}
            className="absolute -bottom-16 right-0 w-[62%] overflow-hidden rounded-[20px] border border-gold-500/25 shadow-2xl"
          >
            <motion.div
